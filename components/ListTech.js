...
import animBoxTech from "../animGsap/animBoxTech";
  ...
  return (
    <div className="listTech">
      ...
      <div className="boxCont2">
        <div className="box2">
          <h4>Besoin d'un développeur full stack</h4>
          <h5>QUE POURRIONS-NOUS FAIRE ENSEMBLE ?</h5>
          <p>
            Je développe des projets web, quelles que soient leurs dimensions,
            de la landing page à l’application web en passant par le SaaS, pour
            des petites et moyennes entreprises. J’ai une aspiration certaine
            pour les projets entrepreneuriaux innovants, et les méthodes agiles.
          </p>
          <Stack spacing={2} direction="row">
          <Button onClick={handleClickS} variant="contained">En savoir plus</Button>
          </Stack>
        </div>
